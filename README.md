# Customer Behaviour (CSB)

A small-scale **Customer Behaviour Analysis** project built using **Python and Power BI**.
...
│
├── data/
│   └── csb_data.csv          # Source dataset
│
├── pbi_data/
│   └── csb.pbix              # Power BI dashboard
│
├── csb_notebook.ipynb        # Python data analysis
│
